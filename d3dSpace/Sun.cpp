...
Sun::Sun(Graphics& gfx, float radius)
	:
	mesh(gfx, radius),
	cbuf(gfx)
{
...
void Sun::SpawnControlWindow() noexcept
{
	if (ImGui::Begin("Sun"))
	{
		ImGui::Text("Position");
...
void Sun::Draw(Graphics& gfx) const noexcept(!IS_DEBUG)
{
	mesh.SetPos(cbData.pos);
	mesh.Draw(gfx);
}

void Sun::Bind(Graphics& gfx, DirectX::FXMMATRIX view) const noexcept
{
